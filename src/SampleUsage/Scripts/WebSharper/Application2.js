(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,amplify,alert,String,Application2,Client,PostModel,Arrays,List,UI,Next,Doc,T,AttrProxy,Key,ListModel,Unchecked,console;
